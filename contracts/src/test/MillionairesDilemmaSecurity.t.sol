...
//         // Set deployer to the test contract itself
//         deployer = address(this);
        
//         // Log the deployer address for debugging
//         console.log("Deployer address:", deployer);
        
//         // Create and initialize implementation
//         implementation = new MillionairesDilemma();
//         implementation.initialize(deployer);
        
//         // Log the owner of implementation
//         console.log("Implementation owner:", implementation.owner());
        
//         // Create factory with the implementation
//         factory = new MillionairesDilemmaFactory(address(implementation));
        
//         // Log the owner of factory
//         console.log("Factory owner before transfer:", factory.owner());
        
//         // Explicitly transfer ownership of factory to the test contract
//         vm.startPrank(factory.owner());
//         factory.transferOwnership(deployer);
//         vm.stopPrank();
        
//         console.log("Factory owner after transfer:", factory.owner());
...
//         // Create game directly from the test contract
//         address gameAddress = factory.createGame("Test Game", participants, names);
//         game = MillionairesDilemma(gameAddress);
        
//         // Log the owner of the game
//         console.log("Game owner:", game.owner());
        
//         // If the game owner is not the deployer, transfer ownership
//         if (game.owner() != deployer) {
//             vm.startPrank(game.owner());
//             game.transferOwnership(deployer);
//             vm.stopPrank();
//             console.log("Game ownership transferred to:", deployer);
//         }
//     }
